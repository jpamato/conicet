...
<head>
    ...
    <title>Ranking by Won Matches - Fulbo Galaxy</title>
        ...
        <div class="main">
            <div class="container">
                ...
                <div class="ranking-title">				
                    ...
                    <h1>Ranking by Won Matches (only for Twitter Users)</h1>
                </div>
...
WHERE 
	tracking.timestamp BETWEEN '" . $fyear . "-" . $fm . "-" . $fd . " 00:00:01' AND '" . $tyear . "-" . $tm . "-" . $td . " 23:59:59'
	AND tracking.score_team2 > tracking.score_team1 
GROUP BY 
	tracking.email
ORDER BY
	totalMatches DESC
			...
			$twitterName = "@" . $twitterName;
					?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row["totalMatches"]; ?></td>			  
                        </tr>
	<?php 
		$num++;
		} 
